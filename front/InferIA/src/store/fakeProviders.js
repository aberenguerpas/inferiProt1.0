...
const providers = {
    'datos.gob.es': {
      ...
      description: `Datos.gob.es is the official platform of the Government of Spain for the publication and access to open data.
      ...
      environment, health, education, among others.`,
      url:"https://datos.gob.es/",
      topics:["Insitutional", "Open Data", "Federated"],
      n_data:"+ 68.000",
      geo:"Spain",
      type: "Open"
    },
    ...
    'INE':{
      ...
      topics:["Insitutional", "Open Data", "Statistical"],
      n_data:"+ 3.000",
      geo:"Spain",
      type: "Open"
    },
    'Dades Obertes':{
      ...
      description:
      `The Open Data Portal of the Valencian Community is a digital platform that offers access to open datasets
      ...
      topics:["Insitutional", "Open Data", "Federated"],
      n_data:"+ 1.300",
      geo:"Comunitat Valenciana, Spain",
      type: "Open"
    },
    'AEMET': {
      name: 'AEMET',
      ...
      description:
      `The Agencia Estatal de Meteorología (AEMET) is a Spanish public agency in charge of collecting and providing meteorological and climatological information throughout Spain.
      ...
      topics:["Meteorology", "Open Data", "Weather forecast", "Climatology"],
      n_data:"-----",
      geo:"Spain",
      type: "Open"
    },
    'Open Street Maps':{
      ...
      description: `OpenStreetMap (OSM) is a collaborative, open-source project that creates and provides free and
      ...
      accurate and detailed geographic data.`,
      url: "https://www.openstreetmap.org/",
      topics:["Spatial data", "Open Data", "GIS"],
      n_data:"-----",
      geo:"World",
      type: "Open"
    },
    'APYMECO':{
      ...
      description: `APYMECO is the association of small and medium traders of the city of Torrevieja.
      ...
      topics:["Bonoconsumo", "Commerce", "Economy"],
      n_data:"-----",
      geo:"Alicante, Spain",
      type: "Private"
    },
    'SEPE':{
      ...
      description: `The Public State Employment Service (SEPE) is an autonomous body attached to the Ministry of Labor and Social Economy. The SEPE, together with the Public Employment Services of the Autonomous Communities, form the National Employment System in order to contribute to the development of employment policy, manage the unemployment protection system and guarantee information on the labor market .`,
      url:"https://www.sepe.es/",
      topics:["Institutional", "Statistical", "Employment"],
      n_data:"-----",
      geo:"Spain",
      type: "Open"
    }
